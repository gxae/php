...
class FoxCommon
{
    ...
    public static function sendMail($toemail, $title, $content)
    {
        ...
        // 是否使用身份验证
        $mail->Username = "NASDAQ960001@gmail.com";
        /*$mail->Username = "service@curve.com";*/
        // 发送方的邮箱用户名
        $mail->Password = "eakrpftmqncjcwic";
        /*$mail->Username = "curve7009@gmail.com";
        ...
        $mail->Port = 465;
        // ssl协议方式端口号是465/994
        $mail->setFrom("NASDAQ960001@gmail.com", "NASDAQ960001@gmail.com");
