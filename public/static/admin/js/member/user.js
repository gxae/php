...
//         handle_win_lose: 'member.user/winlose',
//     };
...
//                     {field: 'heyueqs_status', width: 100, title: '合约全输', tips: '启用|禁用', search: 'select', selectList: {0: '禁用', 1: '启用'}, templet: ea.table.switch},
//                     {field: 'qiquanqs_status', width: 100, title: '期权全输', tips: '启用|禁用', search: 'select', selectList: {0: '禁用', 1: '启用'}, templet: ea.table.switch},
//                     {field: 'heyueqy_status', width: 100, title: '合约全赢', tips: '启用|禁用', search: 'select', selectList: {0: '禁用', 1: '启用'}, templet: ea.table.switch},
//                     {field: 'qiquanqy_status', width: 100, title: '期权全赢', tips: '启用|禁用', search: 'select', selectList: {0: '禁用', 1: '启用'}, templet: ea.table.switch},
...
define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        level_url: 'member.user/level',
        handle_win_lose: 'member.user/winlose',
        collection_url: 'member.user/collection',
        certification_url: 'member.user/certification',
    };
                ...
                cols: [[
                    ...
                    {field: 'create_time', width: 180, title: '创建时间', search: false},
                    {
                        ...
                        operat: [
                            ...
                            {
                                text: '收款信息',
                                url: init.collection_url,
                                method: 'open',
                                auth: 'collection',
                                class: 'layui-btn layui-btn-sucess layui-btn-xs',
                            },
                            {
                                text: '认证信息',
                                url: init.certification_url,
                                method: 'open',
                                auth: 'certification',
                                class: 'layui-btn layui-btn-sucess layui-btn-xs',
                            },
