            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'status', title: '状态', minWidth: 200, search: 'select', selectList: {1: '处理中', 2: '已成功', 3: '已失败'}, templet: function(d){
                        ...
                        var dt1 = '<a class="layui-btn layui-btn-xs layui-btn-warm" data-open="member.wallet_log/ewithdraw?id='+d.id+'" data-title="处理">查看</a>';
                        if (d.status == 3) {
                            return '<span class="layui-btn layui-btn-xs layui-btn-danger">已失败</span>'+dt1;
                        } else if (d.status == 2) {
                            return '<span class="layui-btn layui-btn-xs">已成功</span>'+dt1;
                        } else{
                            return '<span class="layui-btn layui-btn-xs layui-btn-normal">处理中</span>'+dt;
                        }
                    }},
