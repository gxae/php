...
//                         } else if (d.is_win > 1) {
//                             var dt = '<div class="div-cos"><label>单亏损：</label>'+d.all_fee+'</div>';
//                         }else {
...
//                         return dt;
//                     }},
//                     {field: 'play_time', title: '秒数', minWidth: 100},
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'kong_type', title: '控', width: 100, search: 'select', selectList: {0: '中', 1: '赢',2: '亏'}, templet: function(d){
                        //if (d.op_status === 0 && d.kong_type === 0 && d.end_price === '0.00000000'){
                        if (d.op_status === 0  && d.end_price === '0.00000000'){
                            // if(d.kong_type == 0){
                            //     var selecteda = 'selected';
                            //     var selectedb = '';
                            //     var selectedc = '';
