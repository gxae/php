                ...
                if (cols.length > 0) {
                    $.each(cols, function (i, v) {
                        ...
                        if (v.filter !== false && tableInit.modify_url !== false) {
                            if(v.filter == 'heyueqs_status' || v.filter == 'qiquanqs_status' || v.filter == 'heyueqy_status' || v.filter == 'qiquanqy_status'){
                                admin.table.listenSwitch({filter: v.filter, url: tableInit.handle_win_lose, tableId: tableId, modifyReload: modifyReload});
                            }else{
