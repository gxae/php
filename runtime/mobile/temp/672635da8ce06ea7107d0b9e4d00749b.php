<?php /*a:5:{s:66:"/www/wwwroot/nasdaqhome.com/app/mobile/view/finance/opfinance.html";i:1637421166;s:63:"/www/wwwroot/nasdaqhome.com/app/mobile/view/layout/default.html";i:1630206160;s:70:"/www/wwwroot/nasdaqhome.com/app/mobile/view/./finance/mobile_menu.html";i:1638969414;s:72:"/www/wwwroot/nasdaqhome.com/app/mobile/view/./block/mobile_footmenu.html";i:1637392268;s:68:"/www/wwwroot/nasdaqhome.com/app/mobile/view/./block/foot_script.html";i:1639227710;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @LastEditTime: 2021-10-08 17:53:18
 * @Description: Forward, no stop
-->
...
<!--    <li <?php if($leftmenu=='cm'): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('finance/cmfinance'); ?>"><?php echo lang('mobile_finance.cm_title'); ?></a></li>-->
    ...
    <li <?php if($leftmenu=='yka'): ?> class="layui-this"<?php endif; ?>><a href="<?php echo url('finance/yingkuitongji'); ?>"><?php echo lang('finance.yinkui_tongji'); ?></a></li>
			...
			<div class="mt-10">
				<!--<?php echo lang('tradelog.tab_list_c'); ?>--><?php echo lang('finance.op_title'); ?>： <span>$ <?php echo htmlentities($sum_usd); ?></span>
			</div>
			<div class="mt-10">
			...
			<table class="layui-table" lay-skin="nob">
				...
				<tr id="list_<?php echo htmlentities(strtolower($vo['title'])); ?>">
					<td><span class="color-blue font-18"><?php echo htmlentities($vo['title']); ?></span>
						...
						<p class="mt-10"><?php echo htmlentities($vo['op_money']); ?></p>
					</td>
					<td><span>&nbsp;</span>
						<p class="color-l-blue mt-10"><?php echo lang('finance.top_lock'); ?></p>
						<p class="mt-10"><?php echo htmlentities($vo['lock_op_money']); ?></p>
					</td>
					<td class="text-right">
						...
						<p class="mt-10"><?php echo htmlentities($vo['op_usd']); ?></p>
					</td>
					</tr>
					<tr class='memu_<?php echo htmlentities(strtolower($vo['title'])); ?> hidebox memu_box' style="border-top:0;">
						<td colspan="3" class="text-center">
							...
							<a href="<?php echo url('finance/transfer',['type'=>3]); ?>" class="layui-btn layui-btn-normal"><?php echo lang('finance.right_transfer'); ?></a>
						</td>
					</tr>
