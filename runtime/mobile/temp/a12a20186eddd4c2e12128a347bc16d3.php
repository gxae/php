<?php /*a:4:{s:58:"/www/wwwroot/61.4.114.53/app/mobile/view/wicket/login.html";i:1683616595;s:60:"/www/wwwroot/61.4.114.53/app/mobile/view/layout/default.html";i:1630206160;s:65:"/www/wwwroot/61.4.114.53/app/mobile/view/./block/mobile_lang.html";i:1629906308;s:65:"/www/wwwroot/61.4.114.53/app/mobile/view/./block/foot_script.html";i:1639227710;}*/ ?>
<!--
 * @Author: Fox Blue
...
<div class="header">
    <ul class="layui-nav">
      <li class="layui-nav-item"><a style="padding-left: 0px;" href="<?php echo url('/mobile/index/index'); ?>"><i class="layui-icon layui-icon-left" style="font-size: 18px;"></i></a></li>
...
<div class="login-bg">
	<div class="login-box">
		<div class="login-logo">
			<a href="<?php echo url('/mobile/index'); ?>"><img src="<?php echo sysconfig('site','logo_image'); ?>" ></a>
		</div>
		...
		<!--		<?php endif; ?>-->
		<!--		<?php if(sysconfig('base','member_register') == 'email' ||  sysconfig('base','member_register') == 'all'): ?>-->
		...
		<form class="layui-form">
			<div class="layui-form-item">
				<h5 id="username_txt"><?php echo lang('wicket_page.txt_email'); ?></h5>
				<input type="text" id="username" name="username" lay-verify="required" lay-verType="tips" lay-reqText="" placeholder="<?php echo fox_all_replace(lang('wicket_page.please_input'),lang('wicket_page.txt_email')); ?>" value="" class="layui-input" autocomplete="off"/>
			</div>
			<div class="layui-form-item">
			...
			<div class="login-btn">
				<button class="layui-btn layui-btn-normal btn-xxx btn-xr-6 font-18" lay-submit lay-filter="checkLogin"><?php echo lang('wicket_page.login_btn'); ?></button>
			</div>
		</form>
		<div class="login-phone">
			<p><a href="<?php echo url('wicket/forget'); ?>" class="link-b"><?php echo lang('wicket_page.forget_pass'); ?></a></p>
            <!--<?php if(sysconfig('base','site_kefu')): ?>-->
            <!--<p><a href="<?php echo sysconfig('base','site_kefu'); ?>" class="link-b"><?php echo lang('public_memu.kefu'); ?></a></p>-->
            <!--<?php endif; ?>-->
			...
			<div class="foot-boxs"><a href="<?php echo url('wicket/register'); ?>" class="link-b"><?php echo lang('wicket_page.free_register'); ?></a></div>
		</div>
	</div>
</div>
<style type="text/css">
...
<script src="/static/mobile/js/index/wicket.js?v=<?php echo htmlentities($version); ?>"></script>
<script>
