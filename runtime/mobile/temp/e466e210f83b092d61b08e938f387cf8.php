	...
	<div class="login-box">
		...
		<form class="layui-form" action="">
			<div class="layui-form-item">
				...
				<!--	</select>-->
				<!--</div>-->
				<input type="text" id="username" name="username" lay-verify="required" lay-verType="tips" lay-reqText="" placeholder="<?php echo fox_all_replace(lang('wicket_page.please_input'),lang('wicket_page.login_email')); ?>" value="" class="layui-input" autocomplete="off" />
			</div>
