...
<div class="login-bg">
	...
	<div class="login-box">
		...
		<form class="layui-form">
			...
			<div class="login-btn">
				<button class="layui-btn layui-btn-normal btn-xxx btn-xr-6 font-18" lay-submit lay-filter="checkForget"><?php echo lang('wicket_page.forget_btn'); ?></button>
			</div>
		</form>
...
layui.use(['layer', 'form', 'jquery'], function(){
	...
	$('#btnSendCode').on('click', function() {
		...
		if(username.length > 3){
			$.ajax({
				url: "<?php echo url('wicket/getcodes'); ?>",
