<?php /*a:2:{s:67:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/product/cate/edit.html";i:1623592350;s:64:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @LastEditTime: 2021-06-13 21:52:30
 * @Description: Forward, no stop
-->
    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="image" class="layui-input layui-col-xs6"   placeholder="请上传分类图片" value="<?php echo htmlentities((isset($row['image']) && ($row['image'] !== '')?$row['image']:'')); ?>">
