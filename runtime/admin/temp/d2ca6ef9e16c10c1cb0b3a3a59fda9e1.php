<?php /*a:2:{s:67:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/member/group/edit.html";i:1624252056;s:64:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @LastEditTime: 2021-06-21 13:07:36
 * @Description: Forward, no stop
-->
    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input" lay-verify="required" placeholder="请输入权限名称" value="<?php echo htmlentities((isset($row['name']) && ($row['name'] !== '')?$row['name']:'')); ?>">
            </div>
        </div>
