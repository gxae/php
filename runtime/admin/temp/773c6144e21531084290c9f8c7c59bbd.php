<?php /*a:2:{s:70:"/www/wwwroot/nasdaqhome.com/app/admin/view/member/user/collection.html";i:1661098596;s:62:"/www/wwwroot/nasdaqhome.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="yhkdz" class="layui-input"  placeholder="请输入银行卡号" value="<?php echo htmlentities($collection['yhkdz']); ?>">
            </div>
        </div>
        <div class="layui-form-item">
