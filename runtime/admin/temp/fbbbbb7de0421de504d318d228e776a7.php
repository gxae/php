<?php /*a:2:{s:64:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/system/admin/edit.html";i:1632822386;s:61:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @Author: Fox Blue
 * @Date: 2021-05-31 13:44:29
 * @LastEditTime: 2021-09-28 17:46:27
 * @Description: Forward, no stop
-->
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="email" class="layui-input" lay-reqtext="请输入用户邮箱" placeholder="请输入用户邮箱" value="<?php echo htmlentities((isset($row['email']) && ($row['email'] !== '')?$row['email']:'')); ?>">
                <tip>填写用户邮箱。</tip>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="chatsns" class="layui-input" lay-reqtext="请输入用户在线联系" placeholder="请输入用户在线联系" value="<?php echo htmlentities((isset($row['chatsns']) && ($row['chatsns'] !== '')?$row['chatsns']:'')); ?>">
                <tip>填写用户在线联系。</tip>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php endforeach; ?>
                <i class="layui-icon layui-icon-tips" lay-tips="设置一种权限" ></i>
            </div>
        </div>
