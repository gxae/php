<?php /*a:2:{s:61:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/index/index.html";i:1649940540;s:64:"/www/wwwroot/www.nsdkaqnn.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
...
<link rel="stylesheet" href="/static/plugs/lay-module/layuimini/themes/default.css?v=<?php echo time(); ?>" media="all">
 <script src="https://libs.baidu.com/jquery/2.0.0/jquery.min.js"></script>
    <audio id="test" src="/static/tixing2.mp3"></audio>
    <audio id="test1" src="/static/tixing.mp3"></audio>
    <script>
        $(document).ready(function () {
            _tx();
            _sm();
            function _tx() {
                var formurl = "<?php echo Url('member.wallet_log/withdrawnotice'); ?>"
                $.get(formurl,function(data){
                    if (data.code == 0 && data.count > 1) {
                        // layer.msg("新的充值或提现订单。。");
            ...
            function _sm() {
                var formurl = "<?php echo Url('member.card/sm'); ?>"
                $.get(formurl,function(data){
                    if (data.code == 0 && data.count > 1) {
                        // layer.msg("新的充值或提现订单。。");
                        var audioEle = document.getElementById("test1");
                        audioEle.load();
                        audioEle.play();   //播放
                    }
                });
                setTimeout(_sm,1000*10);
            }
        });
