<?php /*a:2:{s:70:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/system/config/addconfig.html";i:1624005106;s:61:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @LastEditTime: 2021-06-18 16:31:47
 * @Description: Forward, no stop
-->
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item  layui-row layui-col-xs12">
            ...
            <div class="layui-input-block">
                <select name="group">
                    ...
                    <option value="<?php echo htmlentities($vo['name']); ?>"><?php echo $vo['remark']; ?></option>
                    <?php endforeach; ?>
                </select>
                <tip>选择配置分组。</tip>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" v-model="type" name="type" lay-filter="type" value="<?php echo htmlentities($key); ?>" title="<?php echo htmlentities($val); ?>">
                <?php endforeach; ?>
                <tip class="layui-input-block">配置默认格式。</tip>
            </div>
        </div>

        <div class="layui-form-item" id="radio_type" style="display: none;">
