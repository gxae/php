<?php /*a:2:{s:63:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/system/auth/edit.html";i:1622467496;s:61:"/www/wwwroot/nsdkqdsdf.com/app/admin/view/layout/default.html";i:1649939362;}*/ ?>
<!--
 * @Author: Fox Blue
 ...
 * @Author: Fox Blue
 * @Date: 2021-05-31 13:44:29
 * @LastEditTime: 2021-05-31 21:24:56
 * @Description: Forward, no stop
-->
    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" name="is_front" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($vo); ?>" <?php if($k==$row['is_front']): ?>checked=""<?php endif; ?>>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" name="is_team" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($vo); ?>" <?php if($k==$row['is_team']): ?>checked=""<?php endif; ?>>
                <?php endforeach; ?>
            </div>
        </div>
