				...
				<div class="layui-col-xs9">
					<div class="mt-10">
						<div class="layui-col-xs6">
							<?php echo lang('tradelog.tab_list_f'); ?><?php echo lang('finance.ex_sum_usd'); ?>： <span>$ <?php echo htmlentities($sum_usd); ?></span>
						</div>
						...
						<table class="layui-table" lay-skin="nob">
						  ...
						  <tbody>
						    <?php if(is_array($walletlist) || $walletlist instanceof \think\Collection || $walletlist instanceof \think\Paginator): $i = 0; $__LIST__ = $walletlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								...
								<td><?php echo htmlentities($vo['cm_money']); ?></td>
								<td><?php echo htmlentities($vo['lock_cm_money']); ?></td>
								<td><?php echo htmlentities($vo['cm_usd']); ?></td>
								<td class="operation">
									...
									<a href="<?php echo url('finance/transfer',['type'=>5]); ?>" class="color-blue"><?php echo lang('finance.right_transfer'); ?></a>
								</td>
								</tr>
										...
										<div class="log hidebox">
											<table class="layui-table flow-table" lay-skin="nob">
												...
												<tr>
													...
													<th><?php echo lang('finance.flow_rate'); ?></th>
